...
@app.get(
    ...
    tags=['location_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['merchant_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['modifier_group_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['modifier_group_record_management', 'modifier_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['modifier_record_management', 'modifier_group_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def modifiers_delete(
    ...
    x_apideck_service_id: Optional[str] = Header(None, alias='x-apideck-service-id'),
    raw: Optional[bool] = False,
    filter: Optional[ModifierGroupFilter] = None,
):
    """
    Delete Modifier
    """
...
@app.get(
    ...
    tags=['order_type_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['order_record_management', 'payment_record_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
